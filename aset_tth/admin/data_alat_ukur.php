   ...
   <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0 me-n3">
                ...
                <a href="alat_ukur.php" class="nav-item nav-link">Add Measuring Equipment</a>
            </div>
            </div>
        </div>
    </nav>
    ...
    <div class="container-fluid bg-dark p-10">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-7 text-white">Measuring Equipment</h1>
		...
		<div style="overflow-x: auto;" class="card-body bg-primary">
				<table class="table table-bordered bg-white">
					...
					include('../koneksi.php'); //memanggil file koneksi
							...
							$datas = mysqli_query($koneksi, "SELECT * FROM alat_ukur ORDER BY id_alat_ukur DESC LIMIT 3") or die(mysqli_error($koneksi));
							...
							$page = (isset($_GET['page']))? $_GET['page'] : 1;
						      ...
						      $query = "SELECT * FROM alat_ukur ORDER BY id_alat_ukur DESC LIMIT $limit_start, $limit";
					...
					<tr>
						...
						<?php
						  $query_jumlah = "SELECT count(*) AS jumlah FROM alat_ukur";
