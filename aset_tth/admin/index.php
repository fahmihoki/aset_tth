...
<!-- Topbar Start -->
   ...
   <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0 me-n1">
                <a href="index.php" class="nav-item nav-link">Home</a>
              <a href="pinjam_asset_admin.php" class="nav-item nav-link">Check In</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">MET</a>
                    <div class="dropdown-menu m-0">
                        <a href="data_alat_ukur.php" class="dropdown-item">Measuring Equipment Data</a>
                        <a href="alat_ukur.php" class="dropdown-item">Add Measuring Equipment</a>
...
<body>
    ...
    <form method="GET" action="search.php" style="text-align: center;">
        <label class="display-7 text-white">Search History : </label>
                ...
                <table class="table table-bordered bg-white">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center text-dark">User Name</th>
